    ...
    <>
      ...
      <div className="container">
        ...
        <div className="cardContainer">
          <Link to="/crear-ot" className="card">Crear OT</Link>
          <Link to="/lista-ot" className="card">Órdenes de Trabajo</Link>
        ...
        <div className="table-container">
          ...
          <table>
            ...
            <tbody>
              {ots.length === 0 ? (
                <tr><td colSpan="4" style={{ textAlign: "center", padding: "15px" }}>No hay órdenes recientes</td></tr>
              ) : (
                ots.map((ot) => (
                  <tr key={ot.id_ot}>
                    <td><Link to={`/detalle/${ot.id_ot}`} style={{ fontWeight: 'bold', color: '#333' }}>{ot.codigo}</Link></td>
                    <td>{ot.estado}</td>
